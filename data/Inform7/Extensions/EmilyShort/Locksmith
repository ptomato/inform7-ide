Version 7 of Locksmith by Emily Short begins here.
...
Carry out unlocking keylessly (this is the standard keylessly unlocking rule):
	if using the sequential action option, do nothing; otherwise say "(with [the matching key of the noun])[command clarification break]";
