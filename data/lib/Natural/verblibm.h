...
[ Banner i;
   ...
   if (Story ~= 0) {
        ...
        #Endif; ! TARGET_
        #ifdef NI_BUILD_COUNT; new_line; #endif;
    }
...
[ Places1Sub i j k;
    ...
    objectloop (i has visited) {
        ...
        #ifdef NI_BUILD_COUNT;
        if (k == j-1) print (string) LISTAND__TX;
              ...
              .Prop_Chosen;
                ...
                if (o hasnt moved || o.&describe ~= 0 || f2 == 1) {
                    ...
                    if (o.&describe ~= 0 && RunRoutines(o, describe) ~= 0) {
                        flag = 1;
                        give o ~workflag; k--;
                        #ifdef NI_BUILD_COUNT; ssp = true; #endif;
                    }
                    else {
                      j = o.p;
                      #ifdef NI_BUILD_COUNT;
...
[ Vis_parent_dash o;
    if (o == 0) rfalse;
    if ((o provides component_parent) && (o.component_parent))
        return Vis_parent_dash(o.component_parent);
    return parent(o);
];
