...
@p Memory manager.
This section is slightly simplified, but essentially copied, from the memory
allocator used in the main Inform 7 compiler.

It allocates memory as needed to store the numerous objects of different
...
@d bibliographic_datum_MT 0
@d chapter_MT 1
@d section_MT 2
@d tangle_target_MT 3
@d source_line_array_MT 4
@d web_MT 5
@d paragraph_MT 6
@d cweb_macro_MT 7
@d programming_language_MT 8
@d c_structure_MT 9
@d structure_dependence_MT 10
@d function_MT 11
@d preform_nonterminal_MT 12
@d string_storage_area_MT 13
@d nonterminal_variable_MT 14
@d weave_target_MT 15
@d macro_usage_MT 16
@d weave_format_MT 17
@d hash_table_entry_MT 18
@d hash_table_entry_usage_MT 19
@d structure_element_MT 20
@d structure_permission_MT 21
@d theme_tag_MT 22
@d paragraph_tag_MT 23
@d tex_results_MT 24

@d NO_MEMORY_TYPES 25 /* must be 1 more than the highest |_MT| constant above */
