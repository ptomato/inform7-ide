...
@Purpose: These utility routines, again by Toby Nelson, look at the headers
of AIFF and OGG files to find the durations, and verify that they are what
they purport to be.

@-------------------------------------------------------------------------------

@ To explicate the following, see the specifications for AIFF and OGG headers.
